...
- **Agent guide** lives at [`CLAUDE.md`](../../CLAUDE.md) (legacy `AGENTS.md` retired). Single source of truth for repo conventions.
...
- **No new tests or GitHub Actions workflows** without an explicit maintainer decision, per the carve-out in `CLAUDE.md`. Testing strategy is documented in [`docs/reference/testing-overview.md`](../reference/testing-overview.md).
