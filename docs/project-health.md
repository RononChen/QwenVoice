...
- Swift tests: 367 cases in 52 files
- Python tests: 553 cases in 41 files
...
| --- | --- | ---: | ---: | --- |
| generation-terminal | backend | 4 | 2 / 14 | macos: stale, ios: stale |
...
| runtime-hardening | backend-release-qa | 5 | 2 / 15 | not hardware-gated |
